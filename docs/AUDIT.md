...
- **Pendências visuais para iterar com o usuário**: ~~tiles decorados~~ ✅ (2026-08-31: grade 10x6 de tiles procedurais do PixelArtRenderer/TERRAINS no explore_scene, shaders de água/grama, layout determinístico por seed — `test_explore_terrain.gd`), ~~animações de caminhada/ataque na arena~~ ✅ (2026-08-31: UnitAnimator por instância na arena — entrada dos dois grupos caminhando até as posições, idle respirando, lunge no ataque + hit/death no alvo, victory nos sobreviventes — `test_arena_animations.gd`), ~~música por mapa~~ ✅ (P0-4), result screen dedicada.
